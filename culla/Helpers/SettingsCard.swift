...
/// the simple pickers it presents) so the utility surface stays calm — the
/// rest of the app's louder glass vocabulary (Galleries, Insights, Duplicate
/// Sweep) keeps using `GlassPanel`.
